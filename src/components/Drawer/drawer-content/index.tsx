    ...
    return (
        <div className="dapp-sidebar">
            <div className="branding-header">
                <Link href="https://Apollo.money" target="_blank">
            ...
            <div className="dapp-menu-links">
                <div className="dapp-nav">
                    ...
                    <Link href="https://apollo11dao.gitbook.io/apollo-dao/" target="_blank" className={classnames("button-dapp-menu", { active: isActive })}>
                        <div className="dapp-menu-item">
            ...
            <div className="dapp-menu-doc-link">
                {/* <Link href="https://apollo11dao.gitbook.io/apollo-dao/" target="_blank">
                    <img alt="" src={DocsIcon} />
                    <p>Docs</p>
                </Link>
