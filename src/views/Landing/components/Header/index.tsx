...
function Header() {
    ...
    return (
        <div className="landing-header">
            <SvgIcon color="primary" component={WonderlandIcon} viewBox="0 0 0 0" style={{ minWidth: 174, minHeight: 50 }} />
                        ...
                        {({ TransitionProps }) => (
                            <Fade {...TransitionProps} timeout={200}>
                                <div className="tooltip">
                                    <Link className="tooltip-item" href="https://twitter.com/APOLLO11DAO" target="_blank">
                                    ...
                                    <Link className="tooltip-item" href="https://github.com/Apollo11dao" target="_blank">
                                        <SvgIcon color="primary" component={GitHub} />
                                        <p>GitHub</p>
                                    </Link>
                                    <Link className="tooltip-item" href="https://medium.com/@APOLLO11DAO" target="_blank">
